...
export const getGeoLocation = post => {
    const waypoint0 = post.waypoint0.MetaInfo.Timestamp;
    const waypoint1 = post.waypoint1.View.Result.Location.DisplayPosition.Latitude + ',' + post.waypoint1.View.Result.Location.DisplayPosition.Longitude;
    return dispatch => {
